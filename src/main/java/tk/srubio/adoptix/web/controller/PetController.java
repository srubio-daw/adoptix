...
public class PetController {
	...
	public @ResponseBody ResponseEntity<AdoptixResponse> getVaccines(@PathVariable(name = "petId") Long petId, @RequestParam int page,
			@RequestParam int rows) {
		return new ResponseEntity<>(vaccineService.getPetVaccines(petId, new PageRequest(page - 1, rows)), HttpStatus.OK);
	}
	
	@RequestMapping(value = "/deleteVaccine/{vaccineId}", method = RequestMethod.GET)
	public @ResponseBody ResponseEntity<AdoptixResponse> deleteVaccine(@PathVariable(name = "vaccineId") Long vaccineId) {
	...
	public @ResponseBody ResponseEntity<AdoptixResponse> saveVaccine(@PathVariable(name = "petId") Long petId, @RequestBody VaccineDTO vaccineForm) {
	...
	public @ResponseBody ResponseEntity<AdoptixResponse> getVetTests(@PathVariable(name = "petId") Long petId, @RequestParam int page,
			@RequestParam int rows) {
		return new ResponseEntity<>(vetTestService.getPetVetTests(petId, new PageRequest(page - 1, rows)), HttpStatus.OK);
	}
	
	@RequestMapping(value = "/deleteMedicalTest/{medicalTestId}", method = RequestMethod.GET)
	public @ResponseBody ResponseEntity<AdoptixResponse> deleteMedicalTest(@PathVariable(name = "medicalTestId") Long medicalTestId) {
	...
	public @ResponseBody ResponseEntity<AdoptixResponse> saveVetTest(@PathVariable(name = "petId") Long petId, @RequestBody VetTestDTO vetTestForm) {
	...
	public @ResponseBody ResponseEntity<AdoptixResponse> getVetVisits(@PathVariable(name = "petId") Long petId, @RequestParam int page,
			@RequestParam int rows) {
		return new ResponseEntity<>(vetVisitService.getPetVetVisits(petId, new PageRequest(page - 1, rows)), HttpStatus.OK);
	}
	
	@RequestMapping(value = "/deleteVetVisit/{vetVisitId}", method = RequestMethod.GET)
	public @ResponseBody ResponseEntity<AdoptixResponse> deleteVetVisit(@PathVariable(name = "vetVisitId") Long vetVisitId) {
	...
	public @ResponseBody ResponseEntity<AdoptixResponse> saveVetVisit(@PathVariable(name = "petId") Long petId, @RequestBody VetVisitDTO vetVisitForm) {
